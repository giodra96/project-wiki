...
- [ ] Focused workflow procedures (`references/*-workflow*.md`)
...
- [ ] **Schema Version**: Compatible with Wiki Schema `1.6.0` (canonical value in `schema/project-wiki.yml`; migration documented if updated).
